...
export const useCases = [
  {
    ...
    body: "Answer repetitive 'where is my freight?' questions with live workflow responses and escalation rules.",
  },
  {
    title: "Exception handling",
    body: "Trigger delay alerts, missing milestone follow-up, and customer updates before service issues spiral.",
  },
  {
    title: "Claims intake",
    body: "Standardize the handoff from customer complaint to documented claim workflow.",
  },
  {
...
export const offers = [
  ...
  },
  {
    ...
    bullets: [
      "Weekly office hours",
      "Prompt and SOP library",
      "Implementation workshops",
      "Peer accountability and Q&A",
    ],
  },
  {
